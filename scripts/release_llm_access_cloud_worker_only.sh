...
ssh "${SSH_OPTS[@]}" "$GCP_DEST" \
  "LLM_ACCESS_ACTIVATE_TARGET=worker LLM_ACCESS_STAGED_WORKER_SERVICE_UNIT=$REMOTE_RELEASE_DIR/llm-access-usage-worker.service.release $REMOTE_RELEASE_DIR/$REMOTE_SCRIPT_NAME"
